var alex,alexhead,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w16,w16,w17,w18,w19,w20,w21,w22,pr1,pr2,pr3,pr4,pr5,pr6,pr7,pr8,edges,oldman,box,osword,gamestate=0,cp1=0,lever1,lever2,lever3,alexm,alexright,alexleft,alexswitchi=0,oswi
...
function preload() {
  ...
  alexleft=loadAnimation("alexleft_0.png","alexleft_1.png","alexleft_2.png","alexleft_3.png","alexright_4.png")
  oswi=loadImage("Sword1_0.png")
}
...
function setup() {
  ...
  pr1=createSprite(900,150,300,300)
  pr1.shapeColor="red"
  pr2=createSprite(1275,100,425,200)
  pr2.shapeColor="red"
  pr3=createSprite(1175,250,225,100)
  pr4=createSprite(525,100,425,200)
  pr4.shapeColor="red"
  pr5=createSprite(625,250,225,100)
  pr6=createSprite(900,750,300,300)
  pr6.shapeColor="red"
  pr7=createSprite(1225,750,325,300)
  pr7.shapeColor="red"
  pr8=createSprite(575,750,325,300)
  pr8.shapeColor="red"
...
function draw() {
  ...
  if(mousePressedOver(pr1)&&cp1===0&&gamestate===0){
    dissapear()
    alex.x=10
    alex.y=10
    oldman.visible=true
    gamestate=1
    pr1.shapeColor="green"
    gamestate===3
  }

  if((mousePressedOver(pr2)||mousePressedOver(pr3))&&cp1===1&&gamestate===0){
    alexreset()
    dissapear()
    lever3.visible=true
    lever2.visible=true
